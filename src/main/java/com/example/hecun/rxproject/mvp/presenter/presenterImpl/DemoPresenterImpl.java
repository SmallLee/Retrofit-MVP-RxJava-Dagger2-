package com.example.hecun.rxproject.mvp.presenter.presenterImpl;
...
/**
 * Presenter层，做具体的数据请求，然后回调给View层，需要继承BasePresenterImpl，实现对应的P接口
 */
public class DemoPresenterImpl extends BasePresenterImpl implements IDemoPresenter{
